...
Elm.Bookmarks = Elm.Bookmarks || {};
Elm.Bookmarks.make = function (_elm) {
   "use strict";
   _elm.Bookmarks = _elm.Bookmarks || {};
   if (_elm.Bookmarks.values) return _elm.Bookmarks.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   var _op = {};
   var showStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "block"}]));
   var hiddenStyle = $Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "none"}]));
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "SelectCategory": return _U.update(model,{currentCategory: $Maybe.Just(_p0._0)});
         case "UpdateURL": return _U.update(model,{newBookmarkURL: _p0._0});
         case "UpdateTitle": return _U.update(model,{newBookmarkTitle: _p0._0});
         case "EditUrl": return _U.update(model,{updateBookmarkURL: _p0._0});
         case "EditTitle": return _U.update(model,{updateBookmarkTitle: _p0._0});
         case "AddBookmark": var newMaxId = model.maxId + 1;
           var newBookmark = {id: newMaxId
                             ,title: model.newBookmarkTitle
                             ,url: model.newBookmarkURL
                             ,categoryName: A2($Maybe.withDefault,"",model.currentCategory)};
           var newBookmarks = A2($Basics._op["++"],model.bookmarks,_U.list([newBookmark]));
           return _U.update(model,{bookmarks: newBookmarks,maxId: newMaxId,newBookmarkURL: "",newBookmarkTitle: "",showCreateBookmark: false});
         case "UpdateBookmark": var updateBookmark = function (bookmark) {
              return _U.eq(bookmark.id,_p0._0) ? _U.update(bookmark,{url: model.updateBookmarkURL,title: model.updateBookmarkTitle}) : bookmark;
           };
           var updatedBookmarks = A2($List.map,updateBookmark,model.bookmarks);
           return _U.update(model,
           {bookmarks: updatedBookmarks,updateBookmarkURL: "",updateBookmarkTitle: "",showUpdateBookmark: false,bookmarkIdBeingEdited: $Maybe.Nothing});
         case "ToggleCreateBookmarkForm": return _U.update(model,{showCreateBookmark: $Basics.not(model.showCreateBookmark)});
         case "ToggleUpdateBookmarkForm": var _p3 = _p0._0;
           var bookmarkBeingEdited = $List.head(A2($List.filter,function (bookmark) {    return _U.eq(bookmark.id,_p3);},model.bookmarks));
           var _p1 = bookmarkBeingEdited;
           if (_p1.ctor === "Just") {
                 var _p2 = _p1._0;
                 return _U.update(model,
                 {showUpdateBookmark: $Basics.not(model.showUpdateBookmark)
                 ,updateBookmarkURL: _p2.url
                 ,updateBookmarkTitle: _p2.title
                 ,bookmarkIdBeingEdited: $Maybe.Just(_p3)});
              } else {
                 return model;
              }
         default: var newBookmarksList = A2($List.filter,function (bookmark) {    return !_U.eq(bookmark.id,_p0._0);},model.bookmarks);
           return _U.update(model,{bookmarks: newBookmarksList});}
   });
   var EditTitle = function (a) {    return {ctor: "EditTitle",_0: a};};
   var EditUrl = function (a) {    return {ctor: "EditUrl",_0: a};};
   var ToggleUpdateBookmarkForm = function (a) {    return {ctor: "ToggleUpdateBookmarkForm",_0: a};};
   var ToggleCreateBookmarkForm = {ctor: "ToggleCreateBookmarkForm"};
   var DeleteBookmark = function (a) {    return {ctor: "DeleteBookmark",_0: a};};
   var bookmarkRow = F2(function (address,bookmark) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.button,
              _U.list([$Html$Attributes.$class("close"),A2($Html$Events.onClick,address,DeleteBookmark(bookmark.id))]),
              _U.list([$Html.text("x")]))
              ,A2($Html.button,
              _U.list([$Html$Attributes.$class("btn btn-link")]),
              _U.list([A2($Html.span,
              _U.list([$Html$Attributes.$class("glyphicon glyphicon-pencil"),A2($Html$Events.onClick,address,ToggleUpdateBookmarkForm(bookmark.id))]),
              _U.list([]))]))
              ,A2($Html.a,_U.list([$Html$Attributes.href(bookmark.url),$Html$Attributes.target("_blank")]),_U.list([$Html.text(bookmark.title)]))]));
   });
   var bookmarkList = F3(function (address,bookmarks,currentCategory) {
      var predicate = function (bookmark) {
         var _p4 = currentCategory;
         if (_p4.ctor === "Nothing") {
               return true;
            } else {
               return _U.eq(bookmark.categoryName,_p4._0);
            }
      };
      var filteredBookmarks = A2($List.filter,predicate,bookmarks);
      var currentCat = A2($Maybe.withDefault,"",currentCategory);
      return A2($Html.div,_U.list([]),A2($List.map,bookmarkRow(address),filteredBookmarks));
   });
   var UpdateBookmark = function (a) {    return {ctor: "UpdateBookmark",_0: a};};
   var updateBookmarkForm = F2(function (address,model) {
      var bkId = A2($Maybe.withDefault,-1,model.bookmarkIdBeingEdited);
      var visibilityStyle = model.showUpdateBookmark ? showStyle : hiddenStyle;
      return A2($Html.div,
      _U.list([visibilityStyle]),
      _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Update Bookmark")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("create-form")]),
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("form-group")]),
                      _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("updateBookmarkTitle")]),_U.list([$Html.text("Bookmark Title")]))
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.$class("form-control")
                                      ,$Html$Attributes.id("updateBookmarkTitle")
                                      ,$Html$Attributes.placeholder("Enter title")
                                      ,$Html$Attributes.type$("text")
                                      ,$Html$Attributes.value(model.updateBookmarkTitle)
                                      ,A3($Html$Events.on,
                                      "input",
                                      $Html$Events.targetValue,
                                      function (_p5) {
                                         return A2($Signal.message,address,EditTitle(_p5));
                                      })]),
                              _U.list([]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("form-group")]),
                      _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("updateBookmarkURL")]),_U.list([$Html.text("Bookmark URL")]))
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.$class("form-control")
                                      ,$Html$Attributes.id("updateBookmarkURL")
                                      ,$Html$Attributes.placeholder("Enter URL")
                                      ,$Html$Attributes.type$("text")
                                      ,$Html$Attributes.value(model.updateBookmarkURL)
                                      ,A3($Html$Events.on,
                                      "input",
                                      $Html$Events.targetValue,
                                      function (_p6) {
                                         return A2($Signal.message,address,EditUrl(_p6));
                                      })]),
                              _U.list([]))]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-info btn-lg")
                              ,$Html$Attributes.type$("submit")
                              ,A2($Html$Events.onClick,address,UpdateBookmark(bkId))]),
                      _U.list([$Html.text("Update")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-default btn-lg pull-right"),$Html$Attributes.type$("button")]),
                      _U.list([$Html.text("Cancel")]))]))]));
   });
   var UpdateTitle = function (a) {    return {ctor: "UpdateTitle",_0: a};};
   var UpdateURL = function (a) {    return {ctor: "UpdateURL",_0: a};};
   var AddBookmark = {ctor: "AddBookmark"};
   var createBookmarkForm = F2(function (address,model) {
      var visibilityStyle = !_U.eq(model.currentCategory,$Maybe.Nothing) ? showStyle : hiddenStyle;
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.button,
              _U.list([visibilityStyle
                      ,$Html$Attributes.$class("btn btn-link")
                      ,$Html$Attributes.type$("button")
                      ,A2($Html$Events.onClick,address,ToggleCreateBookmarkForm)]),
              _U.list([A2($Html.span,_U.list([$Html$Attributes.$class("glyphicon glyphicon-plus")]),_U.list([])),$Html.text("Create Bookmark")]))
              ,A2($Html.div,
              _U.list([$Html$Attributes.classList(_U.list([{ctor: "_Tuple2",_0: "in",_1: model.showCreateBookmark}
                                                          ,{ctor: "_Tuple2",_0: "create-form collapse",_1: true}]))]),
              _U.list([A2($Html.div,
                      _U.list([$Html$Attributes.$class("form-group")]),
                      _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("newBookmarkTitle")]),_U.list([$Html.text("Bookmark Title")]))
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.$class("form-control")
                                      ,$Html$Attributes.id("newBookmarkTitle")
                                      ,$Html$Attributes.placeholder("Enter title")
                                      ,$Html$Attributes.type$("text")
                                      ,$Html$Attributes.value(model.newBookmarkTitle)
                                      ,A3($Html$Events.on,
                                      "input",
                                      $Html$Events.targetValue,
                                      function (_p7) {
                                         return A2($Signal.message,address,UpdateTitle(_p7));
                                      })]),
                              _U.list([]))]))
                      ,A2($Html.div,
                      _U.list([$Html$Attributes.$class("form-group")]),
                      _U.list([A2($Html.label,_U.list([$Html$Attributes.$for("newBookmarkURL")]),_U.list([$Html.text("Bookmark URL")]))
                              ,A2($Html.input,
                              _U.list([$Html$Attributes.$class("form-control")
                                      ,$Html$Attributes.id("newBookmarkURL")
                                      ,$Html$Attributes.placeholder("Enter URL")
                                      ,$Html$Attributes.type$("text")
                                      ,$Html$Attributes.value(model.newBookmarkURL)
                                      ,A3($Html$Events.on,
                                      "input",
                                      $Html$Events.targetValue,
                                      function (_p8) {
                                         return A2($Signal.message,address,UpdateURL(_p8));
                                      })]),
                              _U.list([]))]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-info btn-lg"),$Html$Attributes.type$("submit"),A2($Html$Events.onClick,address,AddBookmark)]),
                      _U.list([$Html.text("Create")]))
                      ,A2($Html.button,
                      _U.list([$Html$Attributes.$class("btn btn-default btn-lg pull-right"),$Html$Attributes.type$("button")]),
                      _U.list([$Html.text("Cancel")]))]))]));
   });
   var SelectCategory = function (a) {    return {ctor: "SelectCategory",_0: a};};
   var categoryRow = F2(function (address,categoryName) {
      return A2($Html.li,
      _U.list([]),
      _U.list([A2($Html.a,_U.list([A2($Html$Events.onClick,address,SelectCategory(categoryName))]),_U.list([$Html.text(categoryName)]))]));
   });
   var sidebar = F2(function (address,categories) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("col-sm-3 col-md-2 sidebar")]),
      _U.list([A2($Html.a,
              _U.list([]),
              _U.list([A2($Html.img,_U.list([$Html$Attributes.$class("logo"),$Html$Attributes.src("assets/img/eggly-logo.png")]),_U.list([]))]))
              ,A2($Html.ul,
              _U.list([$Html$Attributes.$class("nav nav-sidebar")]),
              A2($List.map,function (cat) {    return A2(categoryRow,address,cat.name);},categories))]));
   });
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("row")]),
      _U.list([A2(sidebar,address,model.categories)
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main")]),
              _U.list([A3(bookmarkList,address,model.bookmarks,model.currentCategory)
                      ,A2(createBookmarkForm,address,model)
                      ,A2(updateBookmarkForm,address,model)]))]));
   });
   var initBookmarks = _U.list([{id: 0,title: "AngularJS",url: "http://angularjs.org",categoryName: "Development"}
   ...
   var initCategories = _U.list([{id: 0,name: "Development"},{id: 1,name: "Design"},{id: 2,name: "Exercise"},{id: 3,name: "Humor"}]);
   var initModel = {bookmarks: initBookmarks
                   ,categories: initCategories
                   ,currentCategory: $Maybe.Nothing
                   ...
                   ,updateBookmarkURL: ""
                   ,updateBookmarkTitle: ""
                   ,bookmarkIdBeingEdited: $Maybe.Nothing};
   var main = $StartApp$Simple.start({model: initModel,update: update,view: view});
                              ...
                              return function (j) {
                                 return function (k) {
                                    return {bookmarks: a
                                           ,categories: b
                                           ,currentCategory: c
                                           ,showCreateBookmark: d
                                           ,showUpdateBookmark: e
                                           ,maxId: f
                                           ,newBookmarkURL: g
                                           ,newBookmarkTitle: h
                                           ,updateBookmarkURL: i
                                           ,updateBookmarkTitle: j
                                           ,bookmarkIdBeingEdited: k};
                                 };
                              };
                           };
                        };
   ...
   var Bookmark = F4(function (a,b,c,d) {    return {id: a,title: b,url: c,categoryName: d};});
   var Category = F2(function (a,b) {    return {id: a,name: b};});
   return _elm.Bookmarks.values = {_op: _op
                                  ,Category: Category
                                  ,Bookmark: Bookmark
                                  ,Model: Model
                                  ...
                                  ,ToggleCreateBookmarkForm: ToggleCreateBookmarkForm
                                  ,ToggleUpdateBookmarkForm: ToggleUpdateBookmarkForm
                                  ,EditUrl: EditUrl
                                  ,EditTitle: EditTitle
                                  ,update: update
                                  ,sidebar: sidebar
                                  ...
                                  ,showStyle: showStyle
                                  ,createBookmarkForm: createBookmarkForm
                                  ,updateBookmarkForm: updateBookmarkForm
                                  ,view: view
                                  ,main: main};
};
